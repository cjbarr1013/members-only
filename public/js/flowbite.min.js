!(function (t, e) {
  'object' == typeof exports && 'object' == typeof module ?
    (module.exports = e())
  : 'function' == typeof define && define.amd ? define('Flowbite', [], e)
  : 'object' == typeof exports ? (exports.Flowbite = e())
  : (t.Flowbite = e());
})(self, function () {
  return (function () {
    'use strict';
    var t = {
        ...
        853: function (t, e, i) {
          ...
          function ht(t) {
            return (
              ['html', 'body', '#document'].indexOf(L(t)) >= 0 ?
                  ...
                  setOptions: function (i) {
                    ...
                    (u(),
                      ...
                      (s.scrollParents = {
                        reference:
                          A(t) ? pt(t)
                          : t.contextElement ? pt(t.contextElement)
                          : [],
                        popper: pt(e),
                      }));
                    var a = (function (t) {
        ...
        554: function (t, e) {
          ...
          function Q(t, e, i) {
            ...
            return (
              e(r) ? r
              : r !== i && r.parentElement ? Q(t, e, i, n + 1)
              : void 0
            );
          }
          function Z(t, e) {
                    ...
                    value: function (t, e, i) {
                      ...
                      if (n) {
                        ...
                        n.content &&
                          (function (t, e) {
                            (at(t),
                              e instanceof DocumentFragment ? t.appendChild(e)
                              : 'string' == typeof e ? t.appendChild(nt(e))
                          ...
                          Array.from(this.dow.children).forEach(
                            function (t, e) {
                              ...
                              ((t.textContent = i.dayNames[n]),
                                (t.className =
                                  i.daysOfWeekDisabled.includes(n) ?
            ...
            var a = o && t === o.datepickers[1],
              s = e.reduce(function (t, e) {
                ...
                if (n.pickLevel > 0) {
                  ...
                  i =
                    1 === n.pickLevel ?
                      a ? r.setMonth(r.getMonth() + 1, 0)
                      : r.setDate(1)
                    : a ? r.setFullYear(r.getFullYear() + 1, 0, 0)
                    : r.setMonth(0, 1);
                }
                return (
            ...
            return a(
              function t(e) {
                ...
                if (d)
                  ...
                  var c =
                    i.container ? document.querySelector(i.container) : null;
                  (c && (o.container = c),
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      this.config.multidate ? this.dates.map(i)
                      : this.dates.length > 0 ? i(this.dates[0])
                      : void 0
                    );
                  },
                },
            ...
            s = (function () {
              ...
              return (
                ...
                (t.prototype.getTargetValue = function () {
                  return (
                    'input' === this._options.contentType ? this._targetEl.value
